...
// Експортуємо NotificationPriority для використання в інших модулях
export { NotificationPriority, NotificationType };
...
interface PushNotificationParams extends BaseNotificationParams {
  type: typeof NotificationType.PUSH;
  deviceToken: string;
  title: string;
}
...
class NotificationService {
  ...
  async initializeNotifications(): Promise<void> {
    // Initialize notification queues and consumers
    try {
      // Add your notification initialization logic here
